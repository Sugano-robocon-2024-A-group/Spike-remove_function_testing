...
// PID制御のゲイン
/*
const float kp[4] = {0.0, 100.0, 0.0, 0.0};//(0,1,2,3)  40  0.2  4,0.2 でControlの値が30
const float ki[4] = {0.0, 0.0, 0.0, 0.0};
const float kd[4] = {0.0, 500.0, 0.0, 0.0};//

const float kp[4] = {20.0, 0.0, 0.0, 0.0};//(0,1,2,3)
const float ki[4] = {0, 0.1, 0.1, 0.1};
const float kd[4] = {0, 0.1, 0.1, 0.3};
*/
/*
const int CH4 = 6;  // 制御機器4用ピン*/
/*
const int encoderA[4] = {22, 18, 34, 35};
const int encoderB[4] = {23, 19, 36, 39};
*/
...
float pidCompute(int index, float target, float current) {
    ...
    float output = (kp[index] * error + ki[index] * integral[index] + kd[index] * derivative)/20.0;
